...
VkPipeline VulkanPipelineCache::CreatePipeline(PipelineKey const& key, PipelineDynamicOptions const& dynamicOptions) noexcept {
    ...
    VkPipelineDepthStencilStateCreateInfo vkDs = {
        ...
        .depthCompareOp        = VK_UTILS::GetCompareOp(raster.depthCompareOp),
    ...
    vkDs.front = {
        .failOp      = VK_UTILS::GetStencilOp(stencil.front.stencilOpStencilFail),
        .passOp      = VK_UTILS::GetStencilOp(stencil.front.stencilOpDepthStencilPass),
        .depthFailOp = VK_UTILS::GetStencilOp(stencil.front.stencilOpDepthFail),
        .compareOp   = VK_UTILS::GetCompareOp(stencil.front.stencilFunc),
    ...
    vkDs.back = {
        .failOp      = VK_UTILS::GetStencilOp(stencil.back.stencilOpStencilFail),
        .passOp      = VK_UTILS::GetStencilOp(stencil.back.stencilOpDepthStencilPass),
        .depthFailOp = VK_UTILS::GetStencilOp(stencil.back.stencilOpDepthFail),
        .compareOp   = VK_UTILS::GetCompareOp(stencil.back.stencilFunc),
