...
VkSampler VulkanSamplerCache::GetSampler(Params params) {
    ...
    VkSamplerCreateInfo samplerInfo{
        ...
        .magFilter               = VK_UTILS::TransSamplerMagFilterToVkFilter(samplerParams.filterMag),
        .minFilter               = VK_UTILS::TransSamplerMinFilterToVkFilter(samplerParams.filterMin),
        .mipmapMode              = VK_UTILS::TransSamplerMinFilterToVkSamplerMipmapMode(samplerParams.filterMin),
        .addressModeU            = VK_UTILS::TransSamplerWrapModeToVkSamplerAddressMode(samplerParams.wrapS),
        .addressModeV            = VK_UTILS::TransSamplerWrapModeToVkSamplerAddressMode(samplerParams.wrapT),
        .addressModeW            = VK_UTILS::TransSamplerWrapModeToVkSamplerAddressMode(samplerParams.wrapR),
        ...
        .compareEnable           = VK_UTILS::TransSamplerCompareModeToVkBool32(samplerParams.compareMode),
        .compareOp               = VK_UTILS::TransSamplerCompareFuncToVkCompareOp(samplerParams.compareFunc),
        .minLod                  = 0.0f,
