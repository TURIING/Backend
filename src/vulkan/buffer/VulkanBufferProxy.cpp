...
VulkanBufferProxy::VulkanBufferProxy(const VulkanContextPtr& context, VmaAllocator allocator, const VulkanBufferCachePtr& bufferCache,
                                     VulkanBufferBinding binding, BufferUsage usage, uint32_t numBytes)
